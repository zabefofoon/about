<template>
  <main class="h-full | relative"
        ref="el">
    <section class="w-full h-full | flex | relative bg-purple-900">
      ...
      <div class="flex flex-col | absolute top-1/2 left-16 -translate-y-1/2 | pb-40">
        <h2 class="leading-none text-purple-900 text-outline-2"
            style="font-size: 26rem;  ">Front End</h2>
        <p class="leading-none text-purple-900 text-outline-1"
           style="font-size: 6rem;">Vue, Typescript, TailwindCss</p>
      </div>
      <div class="absolute bottom-20 left-16">
        <p class="text-3xl leading-relaxed korean text-white">
